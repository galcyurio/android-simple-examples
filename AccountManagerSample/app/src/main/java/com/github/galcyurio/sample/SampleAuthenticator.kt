...
class SampleAuthenticator(
    ...
    override fun addAccount(response: AccountAuthenticatorResponse?, accountType: String?, authTokenType: String?, requiredFeatures: Array<out String>?, options: Bundle?): Bundle {
        Log.i("Sample", "addAccount() called")
    ...
    override fun getAuthToken(response: AccountAuthenticatorResponse, account: Account, authTokenType: String, options: Bundle): Bundle {
        Log.i("Sample", "getAuthToken() called")
        ...
        if (authToken.isNullOrEmpty()) {
            ...
            authToken = AuthUseCase.signIn(account.name, password)
        }
    ...
    override fun getAuthTokenLabel(authTokenType: String?): String {
        Log.i("Sample", "getAuthTokenLabel() called")
    ...
    override fun hasFeatures(response: AccountAuthenticatorResponse?, account: Account?, features: Array<out String>?): Bundle {
        Log.i("Sample", "hasFeatures() called")
        return Bundle().apply { putBoolean(KEY_BOOLEAN_RESULT, false) }
    }

    override fun editProperties(response: AccountAuthenticatorResponse?, accountType: String?): Bundle? {
        Log.i("Sample", "editProperties() called")
        return null
    }

    override fun updateCredentials(response: AccountAuthenticatorResponse?, account: Account?, authTokenType: String?, options: Bundle?): Bundle? {
        Log.i("Sample", "updateCredentials() called")
        return null
    }

    override fun confirmCredentials(response: AccountAuthenticatorResponse?, account: Account?, options: Bundle?): Bundle? {
        Log.i("Sample", "confirmCredentials() called")
        return null
    }
}